			...
			<div class="container-fluid">
				<div class="form-head d-flex mb-3 mb-md-4 align-items-start">
					<div class="mr-auto d-none d-lg-block">
						<h3 class="text-black font-w600">Hoşgeldiniz</h3>
						<p class="mb-0 fs-18">Hastane Yönetim Paneli</p>
					</div>
				</div>
				<div class="row">	
							...
							<div class="card-body">
								<div class="media align-items-center">
									<div class="media-body">
										<p class="mb-1">Tıbbi Birimler</p>
										<div class="d-flex flex-wrap">
											<h2 class="fs-40 font-w600 text-white mb-0 mr-3">{{ $tibbibirimler }}</h2>
											<div>	
					...
					<div class="col-xl-3 col-xxl-6 col-sm-6">
						<div class="card gradient-bx text-white bg-success rounded">	
							<div class="card-body">
								<div class="media align-items-center">
									<div class="media-body">
										<p class="mb-1">Doktor</p>
										<div class="d-flex flex-wrap">
											<h2 class="fs-40 font-w600 text-white mb-0 mr-3">{{ $doktorlar }}</h2>
											<div>	
												<svg width="28" height="19" viewBox="0 0 28 19" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<div class="col-xl-3 col-xxl-6 col-sm-6">
						<div class="card gradient-bx text-white bg-info rounded">	
							<div class="card-body">
								<div class="media align-items-center">
									<div class="media-body">
										<p class="mb-1">İstek Şikayet</p>
										<div class="d-flex flex-wrap">
											<h2 class="fs-40 font-w600 text-white mb-0 mr-3">{{ $isteksikayet }}</h2>
											<div>	
												<svg width="28" height="19" viewBox="0 0 28 19" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<div class="col-xl-3 col-xxl-6 col-sm-6">
						<div class="card gradient-bx text-white bg-secondary rounded">	
							<div class="card-body">
								<div class="media align-items-center">
									<div class="media-body">
										<p class="mb-1">İnsan Kaynakları</p>
										<div class="d-flex flex-wrap">
											<h2 class="fs-40 font-w600 text-white mb-0 mr-3">{{ $ik }}</h2>
											<div>	
												<svg width="28" height="19" viewBox="0 0 28 19" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<div class="col-xl-9 col-xxl-8 col-lg-7">
						<div class="card">	
							<div class="card-header border-0 pb-0">
								<h3 class="fs-20 mb-0 text-black">Doktor Listesi</h3>
								<a href="#" class="text-primary font-w500">Hepsi >></a>
							</div>
							<div class="card-body">
								<div class="assigned-doctor owl-carousel">
									@foreach($doktorlarimiz as $d)										
									<div class="itemse">
										<div class="text-center">
											<img src="{{asset('uploads/doktorlar/'.$d->resim)}}" alt="{{ $d->doktoradi }}" >
											<div class="dr-star"><i class="las la-star"></i> 4.2</div>
											<h5 class="fs-16 mb-1 font-w600"><a class="text-black" href="#">{{ $d->doktorunvani }} {{ $d->doktoradi }}</a></h5>
											<span class="text-primary mb-2 d-block">{{ $d->alanadi }}</span>
											<p class="fs-12">{{ $d->telno }}</p>
											<p class="fs-12">{{ $d->email }}</p>
											<div class="social-media">
												<a href="https://www.instagram.com/{{ $d->instagram }}"><i class="lab la-instagram"></i></a>
												<a href="https://www.facebook.com/{{ $d->facebook }}"><i class="lab la-facebook-f"></i></a>
												<a href="https://www.twitter.com/{{ $d->twitter }}"><i class="lab la-twitter"></i></a>
											</div>
										</div>
									</div>
									@endforeach
					...
					<div class="col-xl-3 col-xxl-4 col-lg-5">
                        <div class="card border-0 pb-0">
                            <div class="card-header flex-wrap border-0 pb-0">
                                <h3 class="fs-20 mb-0 text-black">Başvuru Listesi</h3>
								<a href="#" class="text-primary font-w500">Hepsi >></a>
                            </div>
                            <div class="card-body"> 
                                    ...
                                    <ul class="timeline">
                                        <li>
                                            <div class="timeline-panel flex-wrap">
												<div class="media mr-3">
													<img class="rounded-circle" alt="image" width="50" src="{{asset('yonetici/images/widget/1.jpg')}}">
												</div>
                                                <div class="media-body">
													<h5 class="mb-1"><a class="text-black" href="#">Aziz Demir</a></h5>
													<span class="fs-14">24 Yaşında</span>
												</div>
												<a href="javascript:void(0);" class="text-warning mt-2">Onaylandı</a>
											</div>
                                        </li>
                                        <li>
                                            <div class="timeline-panel flex-wrap">
												<div class="media mr-3">
													<img class="rounded-circle" alt="image" width="50" src="{{asset('yonetici/images/widget/2.jpg')}}">
												</div>
                                                <div class="media-body">
													<h5 class="mb-1"><a class="text-black" href="#">Aydın Çakır</a></h5>
													<span class="fs-14">22 Yaşında</span>
												</div>
												<a href="javascript:void(0);" class="text-info mt-2">İncelemede</a>
											</div>
                                        </li>
                                        <li>
                                            <div class="timeline-panel flex-wrap">
												<div class="media mr-3">
													<img class="rounded-circle" alt="image" width="50" src="{{asset('yonetici/images/widget/3.jpg')}}">
												</div>
                                                <div class="media-body">
													<h5 class="mb-1"><a class="text-black" href="#">Emel Çelik</a></h5>
													<span class="fs-14">21 Yaşında</span>
												</div>
												<a href="javascript:void(0);" class="text-danger mt-2">Rededildi</a>
											</div>
                                        </li>
										 <li>
                                            <div class="timeline-panel flex-wrap">
												<div class="media mr-3">
													<img class="rounded-circle" alt="image" width="50" src="{{asset('yonetici/images/widget/5.jpg')}}">
												</div>
                                                <div class="media-body">
													<h5 class="mb-1"><a class="text-black" href="#">Ulvi Yıldız</a></h5>
													<span class="fs-14">26 Yaşında</span>
												</div>
												<a href="javascript:void(0);" class="text-primary mt-2">İncelemede</a>
											</div>
                                        </li>
                                        <li>
                                            <div class="timeline-panel flex-wrap">
                                                ...
                                                <div class="media-body">
													<h5 class="mb-1"><a class="text-black" href="#">Aydın Tunç</a></h5>
													<span class="fs-14">21 Yaşında</span>
												</div>
												<a href="javascript:void(0);" class="text-warning mt-2">Onaylandı</a>
											</div>
                                        ...
                                        <li>
                                            <div class="timeline-panel flex-wrap">
                                                ...
                                                <div class="media-body">
													<h5 class="mb-1"><a class="text-black" href="#">Samet Çınar</a></h5>
													<span class="fs-14">27 Yaşında</span>
												</div>
												<a href="javascript:void(0);" class="text-warning mt-2">Onaylandı</a>
											</div>
                                        </li>
