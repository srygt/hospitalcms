...
@section('parentPageTitle', 'Hızlı Menü İşlemleri ')
@section('title', 'Hızlı Menü Listesi')
@section('content')
<div class="container-fluid">
    <div class="page-titles">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Anasayfa</a></li>
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Hızlı Menü</a></li>
        </ol>
    </div>
    <!-- row -->
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header">
                    <h4 class="card-title"><i class="fa fa-arrow-right"></i> Hızlı Menü Listesi</h4>                    
                    <a href="{{route('yonetici.tanim.hizlimenu.store.get')}}" class="btn btn-success pull-right"><i class="fa fa-plus-square"></i> Ekle</a>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                @foreach($hizlimenu as $v)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('yonetici.tanim.hizlimenu.guncelle.get', $v->id) }}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
...
<script>
    $('.matgis-delete').on('click', function(){
        deleteItem(
            $(this).parents('tr'),
            "{{ route('yonetici.tanim.hizlimenu.destroy', ':id') }}".replace(':id', $(this).data('id'))
        );
    });
</script>   
@stop	
