...
@section('parentPageTitle', 'Hastane İşlemleri ')
@section('title', 'Hastane Listesi')
@section('content')
<div class="container-fluid">
    <div class="page-titles">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Anasayfa</a></li>
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Hastaneler</a></li>
        </ol>
    </div>
    <!-- row -->
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header">
                    <h4 class="card-title"><i class="fa fa-arrow-right"></i> Hastane Listesi</h4>                    
                    <a href="{{route('yonetici.tanim.hastane.store.get')}}" class="btn btn-success pull-right"><i class="fa fa-plus-square"></i> Ekle</a>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                @foreach($hastane as $h)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('yonetici.tanim.hastane.guncelle.get', $h->id) }}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                                                <a data-id="{{ $h->id }}" href="javascript:" class="btn btn-danger shadow btn-xs sharp matgis-delete"><i class="fa fa-trash"></i></a>
                                            </div>	
                                        </td>
                                    </tr>
                                @endforeach                                    
...
<script>
    $('.matgis-delete').on('click', function(){
        deleteItem(
            $(this).parents('tr'),
            "{{ route('yonetici.tanim.hastane.destroy', ':id') }}".replace(':id', $(this).data('id'))
        );
    });
</script>   
@stop	
