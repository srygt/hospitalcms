...
@section('parentPageTitle', 'Anlaşmalı Kurumlar İşlemleri ')
@section('title', 'Anlaşmalı Kurumlar Listesi')
@section('content')
<div class="container-fluid">
    <div class="page-titles">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Anasayfa</a></li>
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Anlaşmalı Kurumlar</a></li>
        </ol>
    </div>
    <!-- row -->
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header">
                    <h4 class="card-title"><i class="fa fa-arrow-right"></i> Anlaşmalı Kurumlar Listesi</h4>                    
                    <a href="{{route('yonetici.tanim.anlasmalikurumlar.store.get')}}" class="btn btn-success pull-right"><i class="fa fa-plus-square"></i> Ekle</a>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="example3" class="display min-w850">
                            ...
                            <tbody>
                                @foreach($anlasmalikurumlar as $v)
                                    <tr>
                                        <td>{{$v->kurumadi }}</td>
                                        <td>@if ($v->durumu === 1)
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('yonetici.tanim.anlasmalikurumlar.guncelle.get', $v->id) }}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
...
<script>
    $('.matgis-delete').on('click', function(){
        deleteItem(
            $(this).parents('tr'),
            "{{ route('yonetici.tanim.anlasmalikurumlar.destroy', ':id') }}".replace(':id', $(this).data('id'))
        );
    });
</script>   
@stop	
