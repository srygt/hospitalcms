        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{route('yonetici.tanim.icerikkategori.store.get')}}" class="btn btn-success pull-right"><i class="fa fa-plus-square"></i> Ekle</a>
                </div>
                <div class="card-body">
...
<script>
    $(document).delegate( '.matgis-delete', "click",function (event) {
        deleteItem(
            $(this).parents('tr'),
            "{{ route('yonetici.tanim.icerikkategori.destroy', ':id') }}".replace(':id', $(this).data('id'))
        );
    });
    $(document).ready(function() {
        let table =  $('#matgistable').DataTable( {
            ...
            ajax: {
                ...
                url: '{{route('yonetici.tanim.icerikkategori.data')}}',
                data: function (d) {
