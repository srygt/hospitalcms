...
@section('parentPageTitle', 'Dil İşlemleri ')
...
<div class="container-fluid">
    <div class="page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Diller</a></li>
        </ol>
    </div>
    <!-- row -->
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header">
                    <h4 class="card-title"><i class="fa fa-arrow-right"></i> Dil Listesi</h4>                    
                    <a href="{{route('yonetici.tanim.dil.store.get')}}" class="btn btn-success pull-right"><i class="fa fa-plus-square"></i> Ekle</a>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                @foreach($dil as $v)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('yonetici.tanim.dil.guncelle.get', $v->id) }}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
...
<script>
    $('.matgis-delete').on('click', function(){
        deleteItem(
            $(this).parents('tr'),
            "{{ route('yonetici.tanim.dil.destroy', ':id') }}".replace(':id', $(this).data('id'))
        );
    });
</script>   
@stop	
