        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{route('yonetici.tanim.politikalarkategori.store.get')}}" class="btn btn-success pull-right"><i class="fa fa-plus-square"></i> Ekle</a>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="example3" class="display min-w850">
                            ...
                            <tbody>
                                @foreach($politikalarkategori as $v)
                                    <tr>
                                        <td>{{$v->kategoriadi }}</td>
                                        <td>@if ($v->durumu === 1)
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('yonetici.tanim.politikalarkategori.guncelle.get', $v->id) }}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
...
<script>
    $('.matgis-delete').on('click', function(){
        deleteItem(
            $(this).parents('tr'),
            "{{ route('yonetici.tanim.politikalarkategori.destroy', ':id') }}".replace(':id', $(this).data('id'))
        );
    });
</script>   
@stop	
