...
@section('parentPageTitle', 'İletişim İşlemleri ')
...
<div class="container-fluid">
    <div class="page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">İletişim</a></li>
        </ol>
    </div>
    <!-- row -->
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header">
                    <h4 class="card-title"><i class="fa fa-arrow-right"></i> İletişim Listesi</h4>                    
                    <a href="{{route('yonetici.iletisim.store.get')}}" class="btn btn-success btn-rounded pull-right"><i class="fa fa-plus-square"></i> Ekle</a>
                </div>
                <div class="card-body">
...
<script>
    $(document).delegate( '.matgis-delete', "click",function (event) {
        deleteItem(
            $(this).parents('tr'),
            "{{ route('yonetici.iletisim.destroy', ':id') }}".replace(':id', $(this).data('id'))
        );
    });
    $(document).ready(function() {
        let table =  $('#matgistable').DataTable( {
            ...
            ajax: {
                ...
                url: '{{route('yonetici.iletisim.data')}}',
                data: function (d) {
