...
@section('parentPageTitle', 'Sponsorluk İşlemleri ')
@section('title', 'Sponsorluk Listesi')
@section('content')
<div class="container-fluid">
    <div class="page-titles">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Anasayfa</a></li>
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Sponsorluklar</a></li>
        </ol>
    </div>
    <!-- row -->
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header">
                    <h4 class="card-title"><i class="fa fa-arrow-right"></i> Sponsorluk Listesi</h4>                    
                    <a href="{{route('yonetici.sponsorluklar.store.get')}}" class="btn btn-success btn-rounded pull-right"><i class="fa fa-plus-square"></i> Ekle</a>
                </div>
                <div class="card-body">
...
<script>
    $(document).delegate( '.matgis-delete', "click",function (event) {
        deleteItem(
            $(this).parents('tr'),
            "{{ route('yonetici.sponsorluklar.destroy', ':id') }}".replace(':id', $(this).data('id'))
        );
    });
    $(document).ready(function() {
        let table =  $('#matgistable').DataTable( {
            ...
            ajax: {
                ...
                url: '{{route('yonetici.sponsorluklar.data')}}',
                data: function (d) {
